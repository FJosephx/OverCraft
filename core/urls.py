...
from .views import agregar_producto_al_carrito, eliminar_producto_en_carrito, cambiar_estado_boleta, poblar, \
    obtener_productos, eliminar_producto_en_bodega, salir, admin_productos, ventas, usuarios, home, ropa, ficha, \
    misdatos, nosotros, registro, iniciar_sesion, administracion, bodega, boleta, miscompras, carrito
...
urlpatterns = [
    ...
    path('password_cambiada/', TemplateView.as_view(template_name='core/password_cambiada.html'),
    ...
    path('eliminar_producto_en_carrito/<carrito_id>', eliminar_producto_en_carrito,
         name='eliminar_producto_en_carrito'),

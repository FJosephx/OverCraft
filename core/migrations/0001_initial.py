# Generated by Django 4.2.7 on 2023-12-21 02:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('descripcion', models.CharField(blank=True, max_length=80, null=True, verbose_name='Descripcion Producto')),
                ...
                ('imagen', models.ImageField(upload_to='images/', verbose_name='Imagen Producto')),
                ('categoria', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='core.categoria', verbose_name='Categoria Producto')),
            ],
        ),
        migrations.CreateModel(
            name='Perfil',

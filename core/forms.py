...
form_file_imagen = {'id': 'id_imagen', 'class': 'form-control-file form-control form-control-sm',
...
class IngresarForm(Form):
    ...
    password = forms.CharField(widget=forms.PasswordInput(attrs=form_control_inicio_sesion_password),
                               label="Contraseña")
...
class PerfilUsuarioForm(Form):
    ...
    imagen = forms.CharField(max_length=100, required=False, label="Imagen")
